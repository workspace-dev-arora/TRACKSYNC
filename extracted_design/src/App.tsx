...
type NavTab = "home" | "requests" | "blocks" | "tasks" | "profile";
    ...
    <div className="flex flex-col h-full bg-[#F7F9FC]">
      ...
      <div className="flex-1 flex flex-col px-6 py-8 overflow-y-auto scroll-hide">
        ...
        <button
          ...
          className="w-full py-4 rounded-2xl text-white font-bold text-base mb-4 shadow-md"
          style={{ background: "linear-gradient(135deg, #123B66, #1769AA)" }}
        >
          Sign In
        </button>

        <button className="w-full py-3 text-sm text-[#1769AA] font-medium">
          Need help?
        </button>
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-4 bg-white border-b border-[#E2E8F0]">
      {onBack && (
        <button
          onClick={onBack}
          className="w-9 h-9 flex items-center justify-center rounded-full bg-[#F7F9FC] text-[#123B66]"
        >
      ...
      >
        <div className="flex items-start justify-between">
          ...
          <button
            ...
            className="relative w-10 h-10 flex items-center justify-center rounded-full bg-white/10 mt-0.5"
          >
      ...
      <div className="px-5 -mt-4 space-y-4 pb-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            <button
              ...
              className="flex flex-col items-center gap-2 py-4 px-2 rounded-2xl bg-white border border-[#E2E8F0] shadow-sm"
            >
              {a.icon}
            ...
            <div className="px-4 py-4 flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <button
                  ...
                  className="mt-2 text-xs font-semibold text-[#1769AA]"
                >
                  View →
                </button>
              </div>
        ...
        >
          ...
          <button
            ...
            className="text-xs font-semibold text-[#F28C28] flex-shrink-0"
          >
            View
          </button>
        </div>
    ...
    <div className="flex-1 overflow-y-auto scroll-hide bg-[#F7F9FC]">
      ...
      <div className="px-5 -mt-2 space-y-4 pb-6 pt-3">
          ...
          >
            <div className="px-5 pt-5 pb-4">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl text-sm font-bold text-[#0B2545]"
          ...
          <div className="space-y-2">
            {tasks.map((t) => (
              <button
                key={t.id}
                onClick={() => onNavigate("active-work")}
                className="w-full bg-white rounded-xl border border-[#E2E8F0] flex items-center gap-3 px-4 py-3.5 text-left"
              >
                <div
        ...
        <button
          ...
          className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl border-2 border-[#FEE2E2] text-left"
...
function RequestsScreen({ onNavigate }: { onNavigate: (s: Screen) => void }) {
        ...
        return (
          <div>
            ...
            <div className="flex gap-3">
              <button className="flex-1 flex flex-col items-center justify-center gap-2 py-5 rounded-2xl border-2 border-dashed border-[#CBD5E1] bg-white">
      ...
      <div className="px-4 py-3 bg-white border-t border-[#E2E8F0] flex gap-3">
        {step > 1 && (
          <button
            ...
            className="flex-1 py-3.5 rounded-xl border-2 border-[#E2E8F0] text-sm font-semibold text-[#64748B]"
          >
            Back
          </button>
        )}
        <button
          ...
          disabled={!canProceed()}
          className="flex-1 py-3.5 rounded-xl text-white text-sm font-semibold transition-all"
  ...
  return (
    <div className="flex flex-col h-full bg-[#F7F9FC]">
      <div className="flex-1 overflow-y-auto scroll-hide px-5 py-8">
        ...
        <button onClick={onDone} className="w-full py-4 rounded-2xl text-white font-semibold text-sm" style={{ background: "#123B66" }}>
          Back to Home
        </button>
      </div>
    </div>
...
function BlocksScreen({ onNavigate }: { onNavigate: (s: Screen) => void }) {
  const blocks = [
      ...
      <div className="flex-1 overflow-y-auto scroll-hide px-4 py-3 space-y-3 bg-[#F7F9FC]">
        {blocks.map((b) => (
          <button
            key={b.id}
            onClick={() => onNavigate("block-detail")}
            className="w-full bg-white rounded-2xl p-4 border border-[#E2E8F0] shadow-sm text-left"
          >
            <div className="flex items-start justify-between mb-2">
              <div>
...
function BlockDetailScreen({ onBack, onNavigate }: { onBack: () => void; onNavigate: (s: Screen) => void }) {
  return (
    <div className="flex flex-col h-full">
...
function ActiveWorkScreen({ onBack, onNavigate }: { onBack: () => void; onNavigate: (s: Screen) => void }) {
      ...
      <div className="flex-1 overflow-y-auto scroll-hide px-4 py-4 bg-[#F7F9FC] space-y-3">
        ...
        {!started ? (
          <button
            ...
            className="w-full py-5 rounded-2xl text-white font-bold text-lg shadow-xl"
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="py-4 rounded-2xl text-sm font-bold border-2 border-[#E2E8F0] bg-white text-[#64748B] flex items-center justify-center gap-2"
            >
              {paused ? <>▶ Resume</> : <>⏸ Pause</>}
            </button>
            <button onClick={() => onNavigate("report-issue")} className="py-4 rounded-2xl text-sm font-bold border-2 border-[#FEE2E2] text-[#DC2626]" style={{ background: "#FFF5F5" }}>
              Report Issue
            </button>
            <button className="py-4 rounded-2xl text-sm font-bold border-2 border-[#E2E8F0] bg-white text-[#64748B] flex items-center justify-center gap-1.5">
              📷 Evidence
            </button>
            <button onClick={() => onNavigate("complete-work")} className="py-4 rounded-2xl text-sm font-bold text-white" style={{ background: "#138A4B" }}>
              Complete Work
            </button>
          </div>
        )}
    ...
    return (
      <div className="flex flex-col h-full bg-[#F7F9FC]">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-5 py-8 text-center">
          ...
          <button onClick={onBack} className="w-full py-4 rounded-2xl text-white font-semibold text-sm" style={{ background: "#123B66" }}>
            Back to Home
          </button>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto scroll-hide px-4 py-4 bg-[#F7F9FC] space-y-4">
        <div className="bg-white rounded-2xl p-4 border border-[#E2E8F0]">
          ...
          {items.map((item) => (
            <button
              ...
              className="w-full flex items-center gap-3 py-4 border-b border-[#F1F5F9] last:border-0 text-left"
            >
              <div
        ...
        <button className="w-full flex items-center gap-4 p-4 rounded-2xl border-2 border-dashed border-[#CBD5E1] bg-white text-left">
          <span className="text-3xl">📷</span>
          <div>
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto scroll-hide px-4 py-4 bg-[#F7F9FC] space-y-4">
          ...
          <div className="space-y-2">
            {["Safety Hazard", "Equipment Failure", "Track Defect", "OHE Fault", "Unauthorized Entry", "Other"].map((t) => (
              <button
                ...
                className="w-full flex items-center justify-between px-4 py-3 rounded-xl border-2 text-sm font-medium text-left transition-all"
        ...
        <div className="flex gap-3">
          <button className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-xl border-2 border-dashed border-[#CBD5E1] bg-white text-sm text-[#64748B] font-medium">📷 Photo</button>
          <button className="flex-1 flex items-center justify-center gap-2 py-3.5 rounded-xl border-2 border-dashed border-[#CBD5E1] bg-white text-sm text-[#64748B] font-medium">🎤 Voice</button>
        </div>
        <button onClick={() => setSubmitted(true)} className="w-full py-4 rounded-2xl text-white font-bold text-sm" style={{ background: "#DC2626" }}>
          Report Issue
        </button>
...
function TasksScreen({ onNavigate }: { onNavigate: (s: Screen) => void }) {
  const tasks = [
      ...
      <div className="flex-1 overflow-y-auto scroll-hide px-4 py-3 space-y-2 bg-[#F7F9FC]">
        {tasks.map((t) => (
          <button
            key={t.id}
            onClick={() => onNavigate("active-work")}
            className="w-full bg-white rounded-xl p-4 border border-[#E2E8F0] flex items-start gap-3 text-left"
          >
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto scroll-hide px-4 py-4 bg-[#F7F9FC] space-y-3">
        ...
        <button className="w-full py-4 rounded-2xl border-2 border-[#FEE2E2] text-sm font-semibold text-[#DC2626]" style={{ background: "#FFF5F5" }}>
          Logout
        </button>
...
export default function App() {
  ...
  const navTabScreenMap: Record<NavTab, Screen> = {
    home: "home",
    requests: "requests",
    blocks: "blocks",
    tasks: "tasks",
  ...
  // Determine header bg for status bar tint
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#D1D9E6] p-4">
      <div
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-1.5">
            <svg width="16" height="11" viewBox="0 0 16 11" fill={screen === "home" ? "white" : "#17202A"}>
              ...
              <rect x="13.5" y="3" width="2.5" height="5" rx="0.5" stroke={screen === "home" ? "white" : "#17202A"} strokeWidth="0.5" fill="none" />
            </svg>
            <svg width="25" height="12" viewBox="0 0 25 12" fill="none">
              <rect x="0.5" y="0.5" width="21" height="11" rx="3.5" stroke={screen === "home" ? "white" : "#17202A"} strokeOpacity="0.35" />
              <rect x="2" y="2" width="17" height="8" rx="2" fill={screen === "home" ? "white" : "#17202A"} />
              <path d="M23 4v4a2 2 0 0 0 0-4z" fill={screen === "home" ? "white" : "#17202A"} opacity="0.4" />
            </svg>
          </div>
        </div>
